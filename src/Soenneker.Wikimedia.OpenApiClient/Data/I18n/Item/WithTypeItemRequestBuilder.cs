...
namespace Soenneker.Wikimedia.OpenApiClient.Data.I18n.Item
{
    ...
    public partial class WithTypeItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wikimedia.OpenApiClient.Data.I18n.Item.WithTypeGetResponse"/></returns>
...
#nullable enable
        public async Task<global::Soenneker.Wikimedia.OpenApiClient.Data.I18n.Item.WithTypeGetResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Wikimedia.OpenApiClient.Data.I18n.Item.WithTypeGetResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Soenneker.Wikimedia.OpenApiClient.Data.I18n.Item.WithTypeGetResponse>(requestInfo, global::Soenneker.Wikimedia.OpenApiClient.Data.I18n.Item.WithTypeGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// &quot;Gets internationalization information for the given site. Currently the onlysupported type is pcs for the Page Content Service.Stability: [experimental](https://www.mediawiki.org/wiki/API_versioning#Experimental)&quot;
        /// </summary>
