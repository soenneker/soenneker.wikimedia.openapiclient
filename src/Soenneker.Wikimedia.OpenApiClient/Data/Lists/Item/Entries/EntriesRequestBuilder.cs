...
namespace Soenneker.Wikimedia.OpenApiClient.Data.Lists.Item.Entries
{
    ...
    public partial class EntriesRequestBuilder : BaseRequestBuilder
    {
        ...
        public EntriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/data/lists/{id}/entries{?next*,sort*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wikimedia.OpenApiClient.Data.Lists.Item.Entries.EntriesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EntriesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/data/lists/{id}/entries{?next*,sort*}", rawUrl)
        {
        }
        /// <summary>
