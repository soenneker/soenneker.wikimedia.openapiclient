...
using Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.Item;
using System.Collections.Generic;
using System.IO;
using System.Threading.Tasks;
using System.Threading;
using System;
namespace Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint
{
    /// <summary>
    /// Builds and executes requests for operations under \transform\wikitext\to\lint
    /// </summary>
    ...
    public partial class LintRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.Item.WithTitleItemRequestBuilder this[string position]
        {
            get
            {
                ...
                return new global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.Item.WithTitleItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.LintRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LintRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/transform/wikitext/to/lint", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.LintRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LintRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/transform/wikitext/to/lint", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Soenneker.Wikimedia.OpenApiClient.Models.PostTransformWikitextToLint200ResponseSchema?> PostAsync(global::Soenneker.Wikimedia.OpenApiClient.Models.PostTransformWikitextToLintFormDataRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Wikimedia.OpenApiClient.Models.PostTransformWikitextToLint200ResponseSchema> PostAsync(global::Soenneker.Wikimedia.OpenApiClient.Models.PostTransformWikitextToLintFormDataRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.LintRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.LintRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Wikimedia.OpenApiClient.Transform.Wikitext.To.Lint.LintRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
